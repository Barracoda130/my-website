        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <section className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <form onSubmit={handleCreateTransaction} className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-6">
              ...
              <input placeholder="Description (optional)" value={transactionForm.description} onChange={(e) => setTransactionForm({ ...transactionForm, description: e.target.value })} className="border border-gray-300 rounded-lg px-3 py-2 text-sm" />
              <button disabled={saving || !hasSetup} className="md:col-span-3 bg-blue-600 text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-blue-700 disabled:opacity-60 cursor-pointer disabled:cursor-not-allowed">Add transaction</button>
            </form>
          ...
          <section className="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <form onSubmit={handleCreateBudget} className="space-y-3 mb-5">
              ...
              <button disabled={saving} className="w-full bg-blue-600 text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-blue-700 disabled:opacity-60 cursor-pointer disabled:cursor-not-allowed">Set budget</button>
            </form>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <section className="bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <form onSubmit={handleCreateGroup} className="space-y-2 mb-4">
              ...
              <button className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm hover:bg-gray-50 cursor-pointer">Add group</button>
            </form>
            <form onSubmit={handleCreateCategory} className="space-y-2 mb-4">
              ...
              <button className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm hover:bg-gray-50 cursor-pointer">Add category</button>
            </form>
            <form onSubmit={handleCreateAccount} className="space-y-2">
              ...
              <button className="w-full border border-gray-300 rounded-lg px-4 py-2 text-sm hover:bg-gray-50 cursor-pointer">Add account</button>
            </form>
          </section>
          ...
          <section className="lg:col-span-2 bg-white rounded-2xl border border-gray-200 p-6">
            ...
            <form onSubmit={handleCreateRecurring} className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-5">
              ...
              <button disabled={saving || !hasSetup} className="bg-blue-600 text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-blue-700 disabled:opacity-60 cursor-pointer disabled:cursor-not-allowed">Add recurring item</button>
            </form>
